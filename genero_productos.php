                    ...
                    <div class="" id="">
                        ...
                        <?php endforeach; ?>
                                    ...
                                    <nav>
                                        ...
                                        <ul class="pagination">
                                            <?php if ($data["actual-section"] != 1): ?> 		  			
                                                <li><a href="../genero_productos.php?busqueda=<?php echo @$_GET['busqueda'] ?>&id_genero=<?php echo $_GET['id_genero'] ?>&busqueda=<?php echo @$_GET['busqueda'] ?>&page=1">Inicio</a></li>
                                                <li><a href="../genero_productos.php?busqueda=<?php echo @$_GET['busqueda'] ?>&id_genero=<?php echo $_GET['id_genero'] ?>&busqueda=<?php echo @$_GET['busqueda'] ?>&page=<?php echo $data['previous']; ?>">&laquo;</a></li>
                                            <?php endif; ?>
                                            ...
                                            <?php $active = ($i == $data["this-page"]) ? "active" : ""; ?>			    
                                                ...
                                                <a href="../genero_productos.php?busqueda=<?php echo @$_GET['busqueda'] ?>&id_genero=<?php echo $_GET['id_genero'] ?>&busqueda=<?php echo @$_GET['busqueda'] ?>&page=<?php echo $i; ?>">
                                                    <?php echo $i; ?>			    		
                                                </a>
                                                </li>
                                                <?php endfor; ?>
                                            ...
                                            <?php if ($data["actual-section"] != $data["total-sections"]): ?>
                                                <li><a href="../genero_productos.php?busqueda=<?php echo @$_GET['busqueda'] ?>&id_genero=<?php echo $_GET['id_genero'] ?>&page=<?php echo $data['next']; ?>">&raquo;</a></li>
                                                <li><a href="../genero_productos.php?busqueda=<?php echo @$_GET['busqueda'] ?>&id_genero=<?php echo $_GET['id_genero'] ?>&page=<?php echo $data['total-pages']; ?>">Final</a></li>
                                                <?php endif; ?>
                                        </ul>
                                    </nav>
                                <?php }  ?>
                            ...
                            <?php if( $banderaError==false){  // si no exite resultado osea marcar erro entonces no presentra paginacion?>
                                    ...
                                    <ul class="pagination">
                                            <?php if ($data["actual-section"] != 1): ?> 		  			
                                                <li><a href="../genero_productos.php?busqueda=<?php echo @$_GET['busqueda'] ?>&id_genero=<?php echo $_GET['id_genero'] ?>&page=1">Inicio</a></li>
                                                <li><a href="../genero_productos.php?busqueda=<?php echo @$_GET['busqueda'] ?>&id_genero=<?php echo $_GET['id_genero'] ?>&page=<?php echo $data['previous']; ?>">&laquo;</a></li>
                                            <?php endif; ?>
                                            ...
                                            <?php $active = ($i == $data["this-page"]) ? "active" : ""; ?>			    
                                                <li class="<?php echo $active; ?>">
                                                <a href="../genero_productos.php?busqueda=<?php echo @$_GET['busqueda'] ?>&id_genero=<?php echo $_GET['id_genero'] ?>&page=<?php echo $i; ?>">
                                                    <?php echo $i; ?>			    		
                                                </a>
                                                </li>
                                                <?php endfor; ?>
