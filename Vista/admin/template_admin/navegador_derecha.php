...
<div class="navbar-right">
    <ul class="navbar-nav">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu slideUp2">
                <li class="header">Notifications <br>Modulo en construccion</li>
                <li class="body">
        ...
        <li><a href="../Vista/admin/index_admin.php?cerrar_session=true" class="mega-menu" title="Cerrar Sesion"><i class="zmdi zmdi-power"></i></a></li>
    </ul>
</div>